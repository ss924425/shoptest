...
<div class="container">
    ...
    <div class="table-responsive">
          ...
          <td class="ring-in"><a href="single.html" class="at-in"><img src="{{ asset('homes/images/ch2.jpg') }} " class="img-responsive" alt=""></a>
            <div class="sed">
                <h5><a href="single.html">Sed ut perspiciatis unde</a></h5>
                <p>(At vero eos et accusamus et iusto odio dignissimos ducimus ) </p>
            </div>
          ...
          <td class="ring-in"><a href="single.html" class="at-in"><img src="{{ asset('homes/images/ch1.jpg') }} " class="img-responsive" alt=""></a>
            <div class="sed">
                <h5><a href="single.html">Sed ut perspiciatis unde</a></h5>
                <p>(At vero eos et accusamus et iusto odio dignissimos ducimus ) </p>
            </div>
