...
<div class="col-md-9">
    <div class="col-md-5 grid">     
        <div class="flexslider">
              <ul class="slides">
                <li data-thumb="{{ asset('homes/images/si.jpg') }}">
                    <div class="thumb-image"> <img src="{{ asset('homes/images/si.jpg') }}" data-imagezoom="true" class="img-responsive"> </div>
                </li>
                <li data-thumb="{{ asset('homes/images/si1.jpg') }}">
                     <div class="thumb-image"> <img src="{{ asset('homes/images/si1.jpg') }}" data-imagezoom="true" class="img-responsive"> </div>
                </li>
                <li data-thumb="{{ asset('homes/images/si2.jpg') }}">
                   <div class="thumb-image"> <img src="{{ asset('homes/images/si2.jpg') }}" data-imagezoom="true" class="img-responsive"> </div>
                </li> 
              </ul>
        </div>
    </div>  
