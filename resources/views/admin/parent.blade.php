...
<head>
  ...
  <link rel="icon" type="image/png" href="{{ asset('admins/images/favicon.png') }}">
  <link rel="apple-touch-icon-precomposed" href="{{ asset('admins/images/app-icon72x72@2x.png') }}">
...
<script src="{{ asset('admins/js/modernizr.js') }}"></script>
<script src="{{ asset('admins/js/rem.min.js') }}"></script>
<script src="{{ asset('admins/js/respond.min.js') }}"></script>
<script src="{{ asset('admins/js/amazeui.legacy.js') }}"></script>
<![endif]-->
