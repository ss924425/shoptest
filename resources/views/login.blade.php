...
<!--theme-style-->
<link href="{{ asset('shop/css/style4.css') }}" rel="stylesheet" type="text/css" media="all" />	
<!--//theme-style-->
...
<div class="container">
		<div class="head">
			<div class=" logo">
				<a href="index.html"><img src="{{ asset('shop/images/logo.png') }}" alt=""></a>	
			</div>
		</div>
	</div>
    		...
    		<li class="dropdown mega-dropdown active">
				...
				<div class="dropdown-menu ">
                    <div class="menu-top">
						...
						<div class="col1 col5">
						<img src="{{ asset('shop/images/me.png') }}" class="img-responsive" alt="">
						</div>
						<div class="clearfix"></div>
					</div>                  
				</div>				
...
<ul>
						...
						<div class="col1 col5">
						<img src="{{ asset('shop/images/me1.png') }}" class="img-responsive" alt="">
						</div>
						<div class="clearfix"></div>
					</div>                  
				</div>				
				...
				<li><a class="play-icon popup-with-zoom-anim" href="#small-dialog"><i class="glyphicon glyphicon-search"> </i></a></li>
					...
					<div class="cart box_1">
						...
						<h3> <div class="total">
							...
							<img src="{{ asset('shop/images/cart.png') }}" alt=""/></h3>
						</a>
			...
			<script src="{{ asset('shop/js/jquery.magnific-popup.js') }}" type="text/javascript"></script>
			<!---//pop-up-box---->
...
<div class="banner-top">
	<div class="container">
		<img src="{{ asset('shop/images/logo1.png') }}">
	</div>
</div>
<!--login-->
<div class="container">
		...
		<div class="container">
			<div class="brand">
				<div class="col-md-3 brand-grid">
					<img src="{{ asset('shop/images/ic.png') }}" class="img-responsive" alt="">
				</div>
				<div class="col-md-3 brand-grid">
					<img src="{{ asset('shop/images/ic1.png') }}" class="img-responsive" alt="">
				</div>
				<div class="col-md-3 brand-grid">
					<img src="{{ asset('shop/images/ic2.png') }}" class="img-responsive" alt="">
				</div>
				<div class="col-md-3 brand-grid">
					<img src="{{ asset('shop/images/ic3.png') }}" class="img-responsive" alt="">
				</div>
				<div class="clearfix"></div>
			</div>
			</div>
	...
	<div class="footer-middle">
				<div class="container">
					<div class="col-md-3 footer-middle-in">
						<a href="index.html"><img src="{{ asset('shop/images/log.png') }}" alt=""></a>
			...
			<div class="footer-bottom">
				<div class="container">
					<ul class="footer-bottom-top">
						<li><a href="#"><img src="{{ asset('shop/images/f1.png') }}" class="img-responsive" alt=""></a></li>
						<li><a href="#"><img src="{{ asset('shop/images/f2.png') }}" class="img-responsive" alt=""></a></li>
						<li><a href="#"><img src="{{ asset('shop/images/f3.png') }}" class="img-responsive" alt=""></a></li>
					</ul>
